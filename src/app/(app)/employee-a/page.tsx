  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">Car Listing Dashboard</h1>
        <Dialog open={isAddCarOpen} onOpenChange={setIsAddCarOpen}>
          <DialogTrigger asChild>
            <Button><PlusCircle className="mr-2 h-4 w-4" /> Add New Car Listing</Button>
          </DialogTrigger>
              ...
              {userListings.map(car => (
                <TableRow key={car.id}>
                  ...
                  <TableCell className="text-right">
                    <Button variant="outline" size="sm" disabled={car.status !== 'pending'}>Edit</Button>
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
